...
Eusebius of Caesarea (260–313 CE[^10]) in his _Onomasticon_ (basically a long list of place names with explanations of their location), not content with his available options of Gerasa and Gadara Eusebius decided to add a third candidate:
...
Gergasa, it has been suggested[^12], is a transliteration of Kursi, located half way up the eastern shore of the Sea of Galilee.

{% include figure image_path="/assets/images/pig-stampede/kursi.jpg" caption="Kursi" %}

Scholarship seems to be split on whether Gergasa/Kursi is a viable option or not:

* “…a site named Khersa (or Kursi) among the cliffs overlooking the lake—the “traditional” site, but with little to argue in its favor.[^13]
* “The “Gerasa” of Mark 5:1 was probably Kursi/Gergesa”[^14]

But, what’s the historical value of Eusebius’ claim? After all it’s not far off 300 years after the events.

{% include figure image_path="/assets/images/pig-stampede/map_kursi.jpg" caption="Kursi in relation to the Sea of Galilee – not far at all" %}
...
{% include figure image_path="/assets/images/pig-stampede/view_of_kinneret_from_kursi.jpg" caption="The Sea of Galilee from Kursi" %}

One thing’s for sure: Gergasa, if it can be equated with Kursi, is “the most geographically plausible”[^16] reading. Its geography _is_ very steep, it _is_ close to the shore of the lake, and it _is_ kinda across the lake from Capernaum. Geographically it’s certainly a better fit than Gerasa or Gadara.
